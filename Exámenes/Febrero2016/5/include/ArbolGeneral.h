  ...
  */
    ...
    private:
        ...
        */
        struct nodo {
            ...
            *
            * Crea un nodo con su etiqueta y los punteros inicializados a cero.
            */
            nodo(): etiqueta(0), izqda(0), drcha(0), padre(0) {};

            /**
            * @brief Constructor con parámetros
            *
            * Crea un nodo con una etiqueta que indique el parámetro
            */
            nodo(const Tbase & e): etiqueta(e), izqda(0), drcha(0), padre(0) {};
        };
    ...
    public:
        ...
        */
        ...
        void insertar_hijomasizquierda(Nodo n, Tbase tb);
        ...
        */
        ...
        void insertar_hermanoderecha(Nodo n, Tbase tb);
        ...
        */
        ...
        void inorden(const ArbolGeneral<Tbase>::Nodo n) ;

        void preorden(const ArbolGeneral<Tbase>::Nodo n) ;
